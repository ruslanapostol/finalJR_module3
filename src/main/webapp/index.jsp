...
<div class="content">
    ...
    <div class="intro">
        <h2>Пролог</h2>
        <p>Звездная дата 2265.9. Вы находитесь в звездном порту Земли и готовитесь к поднятию на борт
            звездолета USS Enterprise. Впереди вас ждут неисследованные миры, новые цивилизации и приключения, о
            которых можно только мечтать.</p>
    ...
    <div class="intro">
        ...
        <p>— Добро пожаловать на борт, капитан! Я — Спок, ваш первый офицер. Позвольте представить вам
            остальных членов экипажа.</p>
        <p>— В инженерном отсеке работает командир Монтгомери Скотт, наш главный инженер. За тактическую
            сторону отвечает лейтенант Хикару Сулу, а наш медицинский офицер — доктор Леонард Маккой.</p>
